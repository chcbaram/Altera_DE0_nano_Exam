...
module niosii_mm_interconnect_0 (
	...
	wire   [4:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire   [4:0] cmd_demux_src2_channel;                                                             // cmd_demux:src2_channel -> crosser_001:in_channel
	...
	wire   [4:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_002:sink0_channel
	...
	wire  [93:0] cmd_demux_src4_data;                                                                // cmd_demux:src4_data -> crosser_002:in_data
	...
	wire  [93:0] crosser_002_out_data;                                                               // crosser_002:out_data -> cmd_mux_004:sink0_data
	...
	wire  [93:0] cmd_demux_001_src0_data;                                                            // cmd_demux_001:src0_data -> crosser_003:in_data
	wire         cmd_demux_001_src0_ready;                                                           // crosser_003:in_ready -> cmd_demux_001:src0_ready
	wire   [4:0] cmd_demux_001_src0_channel;                                                         // cmd_demux_001:src0_channel -> crosser_003:in_channel
	...
	wire  [93:0] crosser_003_out_data;                                                               // crosser_003:out_data -> cmd_mux:sink1_data
	wire         crosser_003_out_ready;                                                              // cmd_mux:sink1_ready -> crosser_003:out_ready
	wire   [4:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> cmd_mux:sink1_channel
	...
	wire  [93:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> crosser_004:in_data
	wire         cmd_demux_001_src2_ready;                                                           // crosser_004:in_ready -> cmd_demux_001:src2_ready
	wire   [4:0] cmd_demux_001_src2_channel;                                                         // cmd_demux_001:src2_channel -> crosser_004:in_channel
	...
	wire  [93:0] crosser_004_out_data;                                                               // crosser_004:out_data -> cmd_mux_002:sink1_data
	wire         crosser_004_out_ready;                                                              // cmd_mux_002:sink1_ready -> crosser_004:out_ready
	wire   [4:0] crosser_004_out_channel;                                                            // crosser_004:out_channel -> cmd_mux_002:sink1_channel
	...
	wire  [93:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> crosser_005:in_data
	wire         cmd_demux_001_src4_ready;                                                           // crosser_005:in_ready -> cmd_demux_001:src4_ready
	wire   [4:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> crosser_005:in_channel
	...
	wire  [93:0] crosser_005_out_data;                                                               // crosser_005:out_data -> cmd_mux_004:sink1_data
	wire         crosser_005_out_ready;                                                              // cmd_mux_004:sink1_ready -> crosser_005:out_ready
	wire   [4:0] crosser_005_out_channel;                                                            // crosser_005:out_channel -> cmd_mux_004:sink1_channel
	...
	wire  [93:0] rsp_demux_src0_data;                                                                // rsp_demux:src0_data -> crosser_006:in_data
	...
	wire  [93:0] crosser_006_out_data;                                                               // crosser_006:out_data -> rsp_mux:sink0_data
	...
	wire  [93:0] rsp_demux_src1_data;                                                                // rsp_demux:src1_data -> crosser_007:in_data
	...
	wire  [93:0] crosser_007_out_data;                                                               // crosser_007:out_data -> rsp_mux_001:sink0_data
	...
	wire  [93:0] rsp_demux_002_src0_data;                                                            // rsp_demux_002:src0_data -> crosser_008:in_data
	wire         rsp_demux_002_src0_ready;                                                           // crosser_008:in_ready -> rsp_demux_002:src0_ready
	wire   [4:0] rsp_demux_002_src0_channel;                                                         // rsp_demux_002:src0_channel -> crosser_008:in_channel
	...
	wire  [93:0] crosser_008_out_data;                                                               // crosser_008:out_data -> rsp_mux:sink2_data
	wire         crosser_008_out_ready;                                                              // rsp_mux:sink2_ready -> crosser_008:out_ready
	wire   [4:0] crosser_008_out_channel;                                                            // crosser_008:out_channel -> rsp_mux:sink2_channel
	...
	wire  [93:0] rsp_demux_002_src1_data;                                                            // rsp_demux_002:src1_data -> crosser_009:in_data
	wire         rsp_demux_002_src1_ready;                                                           // crosser_009:in_ready -> rsp_demux_002:src1_ready
	wire   [4:0] rsp_demux_002_src1_channel;                                                         // rsp_demux_002:src1_channel -> crosser_009:in_channel
	...
	wire  [93:0] crosser_009_out_data;                                                               // crosser_009:out_data -> rsp_mux_001:sink2_data
	...
	wire  [93:0] rsp_demux_004_src0_data;                                                            // rsp_demux_004:src0_data -> crosser_010:in_data
	wire         rsp_demux_004_src0_ready;                                                           // crosser_010:in_ready -> rsp_demux_004:src0_ready
	wire   [4:0] rsp_demux_004_src0_channel;                                                         // rsp_demux_004:src0_channel -> crosser_010:in_channel
	...
	wire  [93:0] crosser_010_out_data;                                                               // crosser_010:out_data -> rsp_mux:sink4_data
	wire         crosser_010_out_ready;                                                              // rsp_mux:sink4_ready -> crosser_010:out_ready
	wire   [4:0] crosser_010_out_channel;                                                            // crosser_010:out_channel -> rsp_mux:sink4_channel
	...
	wire  [93:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> crosser_011:in_data
	wire         rsp_demux_004_src1_ready;                                                           // crosser_011:in_ready -> rsp_demux_004:src1_ready
	wire   [4:0] rsp_demux_004_src1_channel;                                                         // rsp_demux_004:src1_channel -> crosser_011:in_channel
	...
	wire  [93:0] crosser_011_out_data;                                                               // crosser_011:out_data -> rsp_mux_001:sink4_data
	wire         crosser_011_out_ready;                                                              // rsp_mux_001:sink4_ready -> crosser_011:out_ready
	wire   [4:0] crosser_011_out_channel;                                                            // crosser_011:out_channel -> rsp_mux_001:sink4_channel
