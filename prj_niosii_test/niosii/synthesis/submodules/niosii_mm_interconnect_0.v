...
module niosii_mm_interconnect_0 (
	...
	wire  [102:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [102:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire   [84:0] sdram_controller_0_s1_agent_rp_data;                                                // sdram_controller_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire    [4:0] sdram_controller_0_s1_burst_adapter_source0_channel;                                // sdram_controller_0_s1_burst_adapter:source0_channel -> sdram_controller_0_s1_agent:cp_channel
	...
	wire   [84:0] router_006_src_data;                                                                // router_006:src_data -> sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                               // sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [4:0] router_006_src_channel;                                                             // router_006:src_channel -> sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire  [102:0] sdram_controller_0_s1_rsp_width_adapter_src_data;                                   // sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	...
	wire    [4:0] sdram_controller_0_s1_rsp_width_adapter_src_channel;                                // sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire  [102:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> sdram_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                              // sdram_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	wire    [4:0] sdram_controller_0_s1_cmd_width_adapter_src_channel;                                // sdram_controller_0_s1_cmd_width_adapter:out_channel -> sdram_controller_0_s1_burst_adapter:sink0_channel
	...
	wire  [102:0] cmd_demux_src0_data;                                                                // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [102:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [102:0] cmd_demux_001_src0_data;                                                            // cmd_demux_001:src0_data -> crosser_001:in_data
	...
	wire  [102:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux:sink1_data
	...
	wire  [102:0] rsp_demux_src0_data;                                                                // rsp_demux:src0_data -> crosser_002:in_data
	...
	wire  [102:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink0_data
	...
	wire  [102:0] rsp_demux_src1_data;                                                                // rsp_demux:src1_data -> crosser_003:in_data
	...
	wire  [102:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink0_data
	...
	niosii_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
