...
(
    ...
    localparam PAD5 = log2ceil(64'h210c0 - 64'h210a0); 
    localparam PAD6 = log2ceil(64'h210e0 - 64'h210d0); 
    localparam PAD7 = log2ceil(64'h210f0 - 64'h210e8); 
    // -------------------------------------------------------
    ...
    // ( 0x210d0 .. 0x210e0 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 18'h210d0   ) begin
            src_channel = 8'b00010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x210e8 .. 0x210f0 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 18'h210e8   ) begin
